package com.onion.backend.common.service;
...
public class QuartzService {
    ...
    public void addSimpleJob(Class job, String name, String desc, JobDataMap params, Integer seconds) throws SchedulerException {
    ...
    public void addCronJob(Class job, String name, String desc, JobDataMap params, String expression) throws SchedulerException {
        JobDetail jobDetail = buildJobDetail(job, name, desc, params);
    ...
    private JobDetail buildJobDetail(Class job, String name, String desc, JobDataMap params) {
